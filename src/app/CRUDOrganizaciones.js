        ...
        Datos.forEach(documento => {
            ...
            const li = `
                <li class="list-group-item list-group-item-action">
                    ...
                    <button class="btn btn-warning w-100 mb-2 botoneSinSesion Eliminar-Organizacion" data-id="${idDocumento}"> Eliminar </button>
                    <button class="btn btn-success w-100 mb-2 botoneSinSesion Actualizar-Organizacion" data-id="${idDocumento}" data-bs-toggle="modal" data-bs-target="#ActualizarOrganizacion"> Actualizar </button>
                </li>
            `;
            html += li;
        });
